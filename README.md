...
**AITX** — running our deeper technical evening on May 19 at Antler, where Mitch and Fatih from our ML team walk through how we built YOLO26 MLX. Open Q\&A and roundtable after.
...
1. **Public GitHub repo** with your code. Fork our [starter template](https://github.com/webAI/yolomlx-sprint-template) to get a standard structure with a working YOLO26 MLX inference script. Forking is strongly recommended but not required.  
...
Before you start building, read our Getting Started with YOLO26 MLX guide on community.webai.com. It covers setup, requirements, a working hello-world script, and common gotchas.

### **How you'll be judged**

| Category | Points | What we're looking for |
| ----- | ----- | ----- |
| Use of YOLO26 MLX / On-device execution | 20 | Is YOLO26 MLX meaningfully used? Does the demo run locally on Apple Silicon? Is on-device inference central, not decorative? |
| Demo quality / Shipping completeness | 20 | Does it actually work live? Is the user flow clear? Is it stable enough to understand the idea without hand-waving? |
| Impact / Usefulness | 20 | Does it solve a real problem or create a clearly valuable experience? Is the target user obvious? |
| Technical execution | 15 | Is the implementation thoughtful? Good latency, model integration, camera/input handling, architecture, edge-case handling? |
| Creativity / Originality | 15 | Is the idea fresh, clever, surprising, or differentiated from obvious object-detection demos? |
| Presentation / Storytelling | 10 | Did the team explain the problem, solution, demo, and why it matters clearly? |
...
Sign up at community.webai.com. The Build Challenges category is where the brief lives, where the Getting Started guide lives, where the Q\&A happens, and where you'll post your submission. You can attend either or both kickoff events — eligibility is the same regardless of which kickoff you joined.
